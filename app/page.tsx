...
export default function Home() {
	...
	return (
		<main className='mx-8 font-sans md:mx-12 lg:mx-16 2xl:mx-72'>
			<header>
				<h1 className='3xl:my-12 my-6 text-center font-bold text-3xl'>
					Stoic API
				</h1>
			</header>
			...
			<section className='tracking-normal'>
				...
				<div>
					...
					<div className='md:flex md:items-center md:gap-4'>
						{quote ? (
							<div className='inset-shadow-xs mb-2 rounded-md bg-neutral-200 p-3 md:mb-0 md:max-w-xl'>
							...
							<div className='inset-shadow-sm mb-2 w-44 rounded-md bg-neutral-200 p-4 md:mb-0 md:max-w-xl'>
				...
				<h2 className='my-8 font-bold text-xl'>Random Quotes</h2>
				<p className='text-base leading-7'>
				...
				<h2 className='my-8 font-bold text-xl'>
				...
				<p className='text-base leading-7'>
					...
					URL{' '}
					<code className='rounded-md border border-neutral-300 bg-neutral-200 px-2 py-1 font-mono text-foreground text-sm'>
